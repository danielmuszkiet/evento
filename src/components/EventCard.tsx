...
function EventCard({ event }: { event: TEvent }) {
  return (
    <section className="relative flex h-95 max-w-125 flex-1 basis-80 flex-col overflow-hidden rounded-2xl bg-white/3">
      <div className="relative h-[60%] w-full">
        ...
        />
        <section className="0 absolute top-3 left-3 flex h-11.25 w-11.25 flex-col items-center justify-center rounded-md bg-white/10">
